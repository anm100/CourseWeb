    ...
    <div  runat="server" class="frame-table" ng-controller="MyController1" >
        ...
        <div class="table-responsive ">
            <table class="table table-hove">
                ...
                <tbody>
                    <tr runat="server" ng-repeat="roll in grade.json | orderBy:sortType:sortReverse | filter: searchFish">
                        <td>
                            <span>{{roll.Id}}</span>
                            <input runat="server" ng-model="roll.Id" type="number"
                             ...
                             <td>
                            <span >{{roll.assignmentname}}</span>
                            <input runat="server" ng-model="roll.assignmentname" type="text"
